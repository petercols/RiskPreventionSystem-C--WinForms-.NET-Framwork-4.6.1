...
{
    public partial class frmDeshabilitarProfesional : Form
    {
        int habilitado;
        public frmDeshabilitarProfesional()
        {
            InitializeComponent();
        }
        ...
        private void frmDeshabilitarProfesional_Load(object sender, EventArgs e)
        {
            rbNo0.Enabled = true;
            rbSi1.Enabled = true;
        }
